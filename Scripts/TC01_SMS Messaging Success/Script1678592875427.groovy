...
Mobile.setText(findTestObject('Object Repository/Application/OS/android.widget.EditText'), '081238324285', 0)

Mobile.setText(findTestObject('Object Repository/Application/OS/android.widget.EditText (1)'), 'Test SMS Messaging', 0)

Mobile.tap(findTestObject('Object Repository/Application/OS/android.widget.Button - Send'), 0)

Mobile.verifyElementText(findTestObject('Object Repository/Application/OS/android.widget.TextView - Message sent'), 'Message sent!')
